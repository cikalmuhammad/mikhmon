...
<img style="margin:2px ;" width="100" height="35" src="<?php echo $logo;?>" alt="logo">	
</div>
</td>		
<tr>
...
<div style="padding:0px;border-bottom:1.5px solid;text-align:center;font-weight:bold;font-size:27px;color:#000000"><?php echo $username;?>	</div>
...
<b>VOUCHER BONUS,TIDAK BISA DITUKAR</b> 
...
<div style="margin-top:-1px;text-align:center;color:#000000;font-size:8px;font-weight:bold;"><?php echo $validity;?> 
  ...
  <!--https://isbernendi.github.io/-akhir-->	        	        	        	        	        	        	        	        	        	        	        	        	        	        	        	        	        	        	        	        	        																																																																																																																														 <!--https://isbernendi.github.io/-awal-->	
<?php 
if(substr($validity,-1) == "d"){
  $validity = "   <br>MASA AKTIF : ".substr($validity,0,-1)." HARI";
}else if(substr($validity,-1) == "h"){
